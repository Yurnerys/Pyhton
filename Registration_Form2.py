...
Radiobutton(base, text="Female", padx=10,variable=vars, value=2).place(x=245,y=240)  
Radiobutton(base, text="Others", padx=15, variable=vars, value=3).place(x=328,y=240)  
  
list_of_cntry = ("Australia and New Zealand","Caribbean", "Central Asia", "Central America", "Eastern Asia", "Eastern Africa", "Eastern Eurupe", "Middle Africa", "Micronesia", "Melanesia", "Middle Africa", "Northern America", "Northern Europe", "Northern Africa", "South America", "Southern Europe", "Southern Africa", "Southern Asia", "Southeastern Asia", "Western Asia", "Western Africa", "Western Europe")  
cv = StringVar()

drplist= OptionMenu(base, cv, *list_of_cntry)  
drplist.config(width=15)  
cv.set("North America")  
lb2= Label(base, text="Select Region", width=13,font=("arial",12))  
